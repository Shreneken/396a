...
def get_file_name(movie_name, release_date, director):
    ...
    return f"{directory}/{movie_name}-{release_date}-{director}.json"
...
def create_dir(release_date):
    ...
    try:
        int(dir_to_check)
        dir_to_check = "metacritic/" + dir_to_check
    except ValueError:
        dir_to_check = "metacritic/" + "miscellaneous"
